    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The signal you're chasing doesn't exist here.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something went sideways. Refresh or head home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StockSense AI — Investment Operating System" },
      {
        name: "description",
        content:
          "AI-powered investment OS for professional investors. Real-time markets, portfolio intelligence, trading journal, and behavioral analytics.",
      },
      { property: "og:title", content: "StockSense AI — Investment Operating System" },
      {
